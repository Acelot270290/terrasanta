...
class supsystic_promoViewScs extends viewScs {
	...
	public function showFeaturedPluginsPage() {
		...
		$imgUrl = frameScs::_()->getModule('supsystic_promo')->getModPath(). 'img/';
		...
		$this->assign('pluginsList', array(
			...
			array('label' => __('Kinsta Hosting', SCS_LANG_CODE), 'url' => 'https://kinsta.com?kaid=MNRQQASUYJRT', 'external' => true, 'img' => $imgUrl. 'kinsta_banner.png', 'desc' => __('If you want to host a business site or a blog, Kinsta managed WordPress hosting is the best place to stop on. Without any hesitation, we can say Kinsta is incredible when it comes to uptime and speed.', SCS_LANG_CODE)),
		));
